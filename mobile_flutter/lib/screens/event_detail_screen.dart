...
class _EventDetailScreenState extends State<EventDetailScreen> {
  ...
  Future<void> _fetchEventDetails() async {
    try {
      final response = await http.get(
          Uri.parse('http://127.0.0.1:5328/api/v1/events/${widget.eventId}'));
  ...
  Future<void> _addToCalendar() async {
    try {
      ...
      final response = await http.post(
        Uri.parse('http://127.0.0.1:5328/api/v1/events/${widget.eventId}/book'),
        headers: {
  ...
  Future<void> _bookOnEventbrite() async {
    try {
      final response = await http.get(
        Uri.parse(
            'http://127.0.0.1:5328/api/v1/events/eventbrite-link/${widget.eventId}'),
      );
      if (response.statusCode == 200) {
