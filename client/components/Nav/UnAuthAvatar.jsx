...
function UnAuthAvatar() {
  return (
    // <div className="h-full w-full lg:flex lg:w-1/2 justify-center items-center">
      <div className="h-full w-full rounded-full border-2 border-gray-600 shadow-lg bg-gray-700 flex items-center justify-center overflow-hidden">
        <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="#9ca3af" viewBox="0 0 16 16">
