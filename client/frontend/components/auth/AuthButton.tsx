...
export const AuthButton: React.FC<AuthButtonProps> = ({ provider, label, iconSrc, setLoading }) => {
  const handleSignInWithLoadingStatus = async (provider: any) => {
    setLoading(true);
  ...
  return (
    <button
      ...
      onClick={() => handleSignInWithLoadingStatus(provider)}
