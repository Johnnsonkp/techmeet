...
function NavDropDown({user}: any) {
  ...
  return (
    <div className={`${user && user.name? "block": 'hidden'} relative left-11`}>
      <div className="dropdown-menu absolute right-0 mt-2 w-55 bg-white rounded-lg shadow-xl py-1 z-50 opacity-0 invisible transition-all duration-300 transform -translate-y-2 border border-gray-100">
        ...
        <a href="#" className="px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 flex items-center transition-colors duration-200">
            <UserCogIcon size={20}/>
            <span className='ml-2 text-sm'>Account Settings</span>
        </a>
