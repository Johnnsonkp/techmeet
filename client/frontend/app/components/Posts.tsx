import { AllPostsQueryResult, Post as PostType } from "@/sanity.types";
import { allPostsQuery, morePostsQuery } from "@/sanity/lib/queries";

import Avatar from "@/app/components/Avatar";
import CoverImage from "./CoverImage";
import { CoverImageCustom } from "./CoverImage";
...
const PostCustom = ({ post }: { post: AllPostsQueryResult[number] }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex">
      <CoverImageCustom image={coverImage} height={150} width={250}/>
...
export const AllPostsCustom = async () => {
  const { data } = await sanityFetch({ query: allPostsQuery });
